...
import { LayoutDashboard, Mail, FileText, ListChecks, BookOpen, UserCheck, Sparkles } from "lucide-react";
import {
  Sidebar,
  SidebarContent,
  SidebarGroup,
...
const items = [
  ...
  { title: "Candidate Evaluation", url: "/candidate", icon: UserCheck },
];
      ...
      <SidebarHeader className="border-b border-sidebar-border">
        <Link to="/" className="flex items-center gap-2 px-2 py-3">
          ...
          <div className="flex flex-col leading-tight group-data-[collapsible=icon]:hidden">
            ...
            <span className="text-xs text-muted-foreground">HR Productivity</span>
          </div>
        </Link>
      </SidebarHeader>
      <SidebarContent>
